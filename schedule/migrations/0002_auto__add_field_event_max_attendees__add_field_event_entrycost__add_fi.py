...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.max_attendees'
        db.add_column('schedule_event', 'max_attendees',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.entrycost'
        db.add_column('schedule_event', 'entrycost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Event.rsvpcost'
        db.add_column('schedule_event', 'rsvpcost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Event.rsvp_form'
        db.add_column('schedule_event', 'rsvp_form',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.Form'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.max_attendees'
        db.delete_column('schedule_event', 'max_attendees')

        # Deleting field 'Event.entrycost'
        db.delete_column('schedule_event', 'entrycost')

        # Deleting field 'Event.rsvpcost'
        db.delete_column('schedule_event', 'rsvpcost')

        # Deleting field 'Event.rsvp_form'
        db.delete_column('schedule_event', 'rsvp_form_id')
