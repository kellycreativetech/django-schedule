...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attendee.wait_list'
        db.add_column('schedule_attendee', 'wait_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding index on 'Attendee', fields ['attending']
        db.create_index('schedule_attendee', ['attending'])


    def backwards(self, orm):
        # Removing index on 'Attendee', fields ['attending']
        db.delete_index('schedule_attendee', ['attending'])

        # Deleting field 'Attendee.wait_list'
        db.delete_column('schedule_attendee', 'wait_list')
