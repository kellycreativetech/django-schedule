...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('schedule_attendee', 'event_id')

        # Adding field 'Attendee.occurrence'
        db.add_column('schedule_attendee', 'occurrence',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['schedule.Occurrence']),
                      keep_default=False)

        # Adding field 'Attendee.attending'
        db.add_column('schedule_attendee', 'attending',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Attendee.event'
        raise RuntimeError("Cannot reverse this migration. 'Attendee.event' and its values cannot be restored.")
        # Deleting field 'Attendee.occurrence'
        db.delete_column('schedule_attendee', 'occurrence_id')

        # Deleting field 'Attendee.attending'
        db.delete_column('schedule_attendee', 'attending')
