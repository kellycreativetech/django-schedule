...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.rsvp_requested'
        db.add_column('schedule_event', 'rsvp_requested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.rsvp_requested'
        db.delete_column('schedule_event', 'rsvp_requested')
